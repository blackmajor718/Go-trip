...
?>
<div class="border-top-light pt-30 loop-list-car">
                    ...
                    <div class="d-flex flex-column h-full justify-between">
                        ...
                        <?php if(!empty($terms)): ?>
                            ...
                            $translate_term = $term->translate()
                                    ?>
                                    <div class="col-auto">
                                        <div class="border-light rounded-100 py-5 px-20 text-14 lh-14"><?php echo e($translate_term->name); ?></div>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\Project\themes/GoTrip/Car/Views/frontend/layouts/search/loop-list.blade.php ENDPATH**/ ?>