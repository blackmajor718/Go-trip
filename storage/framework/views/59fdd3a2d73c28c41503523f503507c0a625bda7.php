                    ...
                    <div class="roomGrid">
                        ...
                        <div class="roomGrid__grid">
                            <div>
                                ...
                                <a href="javascript:void(0)" class="d-block text-15 fw-500 underline text-blue-1 mt-15" @click="showGallery($event,room.id,room.gallery)"><?php echo e(__('Show Room Information')); ?></a>
...
<?php /**PATH C:\xampp\htdocs\Project\themes/GoTrip/Hotel/Views/frontend/layouts/details/hotel-room-list.blade.php ENDPATH**/ ?>