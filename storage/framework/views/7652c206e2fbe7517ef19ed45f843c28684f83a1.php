<div class="cruiseSlider">
    <div class="cruiseSlider-slider relative">
        <div class="d-flex js-cruise-slider">
            <div class="swiper-wrapper">
                <?php $__currentLoopData = $row->getGallery(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="swiper-slide">
                        <img src="<?php echo e($item['large']); ?>" alt="image" class="rounded-4">
                    </div>
                    <?php if($key == 6): ?>
                        <?php break; ?>
                    <?php endif; ?>
            ...
            <div class="absolute h-full col-12 px-20 py-20 d-flex justify-end items-end gotrip-banner">
                ...
                <?php $__currentLoopData = $row->getGallery(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($key == 0): ?>
                        <a href="<?php echo e($item['large']); ?>" class="button px-24 py-15 -blue-1 bg-white z-2 js-gallery" data-gallery="gallery2">
    ...
    <div class="cruiseSlider-slides row x-gap-10 y-gap-10 pt-10 js-cruise-slides justify-content-center">
        <?php $__currentLoopData = $row->getGallery(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-auto w-max-120">
                <div class="cruiseSlider-slides__item h-full rounded-4 <?php if($key == 0): ?> -is-active <?php endif; ?> js-item">
                    <img src="<?php echo e($item['thumb']); ?>" alt="image" class="h-full object-cover">
                </div>
            </div>
            <?php if($key == 6): ?>
                <?php break; ?>
...
</div><?php /**PATH C:\xampp\htdocs\Project\themes/GoTrip/Layout/common/detail/gallery5.blade.php ENDPATH**/ ?>